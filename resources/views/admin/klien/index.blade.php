...
<div class="row mb-4">
    <div class="col-sm-6">
        <h1 class="h3 d-inline-block">Manajemen Klien/Toko</h1>
    </div>
...
<div class="card">
    <div class="card-body">
        <div class="table-responsive">
            <table id="klienTable" class="table table-striped table-hover">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Nama Klien</th>
