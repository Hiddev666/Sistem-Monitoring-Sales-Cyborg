...
<div class="container mt-4">
    <div class="row mb-4">
        <div class="col-md-12">
            <h2><i class="fas fa-plus-circle"></i> Buat Jadwal Kunjungan</h2>
            <p class="text-muted">Buat jadwal kunjungan untuk diri sendiri</p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('sales.pjp.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="keterangan" id="keterangan"
                                      ...
                                      rows="3" placeholder="Misal: Kunjungan rutin area timur">{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="d-grid gap-2 d-sm-flex justify-content-sm-end">
                            <a href="{{ route('sales.pjp.today') }}" class="btn btn-secondary">
            ...
            <div class="card bg-light">
                ...
                <div class="card-body small">
                    ...
                    <ul>
                        ...
                        <li>Setiap tanggal hanya bisa memiliki satu jadwal</li>
                    </ul>
                </div>
            </div>
        </div>
